...
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg, NavigationToolbar2Tk  # Used to integrate tkinter & matplotlib + create our canvas
import tkinter as tk # The Graphical User Interface (GUI) Library
import numpy as np
from Grade_grapher import Subjs_And_Level_By_Prof_Grapher  # Import
...
# Example: Check user choices and call the appropriate function
selected_subject_value = selected_subject.get()
selected_class_level_value = selected_class_level.get()
selected_class_or_professor_value = class_or_professor.get()

# Get data (replace with actual data retrieval logic)
x, y1, y2 = get_data()

####################### Code removed since redundant w/ Grade_grapher graphing
# Plot the graphs
